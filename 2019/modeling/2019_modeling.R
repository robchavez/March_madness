...
test_data <- read_csv("~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/Processed_data/joined_data.csv")
...
# -------------
#
tourn_2017 <- read_csv("C:/Users/rober//Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2017.csv")
...
test_data_2018 <- read.csv("C:/Users/rober//Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/Processed_data/joined_data.csv")
test_data_2018 <- test_data_2018 %>% filter(season == "2018")

#teams_2016 <- read.csv("C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/teams_2016_new.csv")
#teams_2016 <- teams_2016 %>% filter(season2016 == 1) 


wins <- read_csv("C:/Users/rober//Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2018.csv")
...
# -------------
#
tourn_2018 <- read_csv("C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2018.csv")
...
pred_test_match_2018 <- left_join(tourn_2018,clean_pred_sub)  
