...
#rawdf <- read_csv("~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/all_regseason_cleaned_1996-2019.csv")
rawdf <- read_csv("C:/Users/rober//Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/all_regseason_cleaned_1996-2019.csv")
...
tourn <- read_csv("C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/all_tournament_wins_1996-2018.csv")
#tourn <- read_csv("~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/all_tournament_wins_1996-2018.csv")
...
write_csv(tourn, "C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2018.csv")
#write_csv(tourn, "~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2018.csv")
...
write_csv(nonadf, "C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/seeded_all_regseason_cleaned_1996-2018.csv")
write_csv(nonadf, "C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/Processed_data/joined_data.csv")

#write_csv(nonadf, "~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/seeded_all_regseason_cleaned_1996-2018.csv")
#write_csv(nonadf, "~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/Processed_data/joined_data.csv")
...
# load data
#seeddf <- read_csv("~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/seeded_all_regseason_cleaned_1996-2018.csv")
seeddf <- read_csv("C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/seeded_all_regseason_cleaned_1996-2018.csv")


#seeddf$School <- ifelse(seeddf$School == "University of California", "California", seeddf$School)
#seeddf$School <- ifelse(seeddf$School == "North Carolina-Greensboro", "UNC Greensboro"	, seeddf$School)
#seeddf$School <- ifelse(seeddf$School == 	"Saint Mary's (CA)", "Saint Mary's"	, seeddf$School)
#seeddf$School <- ifelse(seeddf$School == 	"Texas Christian", "TCU"	, seeddf$School)
#seeddf$School <- ifelse(seeddf$School == 	"North Carolina-Wilmington", "UNC Wilmington"	, seeddf$School)
#seeddf$School <- ifelse(seeddf$School == 	"North Carolina State", "NC State"	, seeddf$School)
#seeddf$School <- ifelse(seeddf$School == 	"North Carolina-Asheville", "UNC Asheville"	, seeddf$School)
#seeddf$School <- ifelse(seeddf$School == 	"Arkansas-Little Rock", "Little Rock",seeddf$School)

Radford

#seeddf <- read_csv("C:/Users/rober//Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/seeded_all_regseason_cleaned_1996-2018.csv")

tourney <- read_csv("C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2018.csv")
#tourney <- read_csv("~/Google Drive/Code_scripts/R/forthefuckofit/March_madness_model_2019/renamed_all_tournament_wins_1996-2018.csv")
...
write_csv(both_vars_data_all,"C:/Users/rober/Google Drive/Code_scripts/R/forthefuckofit//March_madness_model_2019/Processed_data/both_model_data.csv")
#write_csv(both_vars_data_all,"~/Google Drive/Code_scripts/R/forthefuckofit//March_madness_model_2019/Processed_data/both_model_data.csv")
...
Dataset_test <- both_data %>% filter(season !=2016) %>%  filter(season != 2017 ) %>% select(-season, -School,  -wteam, -season.1, -season.2, - lteam,  -School.1)

#chart.Correlation(Dataset[-1], col= Dataset$variable)
