...
rawdf <- read_csv("~/Google Drive/March_madness/March_madness-master/2021/all_regseason_cleaned_1996-2021.csv")
...
tourn <- read_csv("~/Google Drive/March_madness/March_madness-master/2021/all_tournament_wins_1996-2018.csv")
...
nonadf <- nonadf %>% filter(season != 2019)


#write_csv(nonadf, "~/Google Drive/March_madness/March_madness-master/2021/Processed_data/joined_data.csv")

#write_csv(nonadf, "~/Google Drive/March_madness/March_madness-master/2021/seeded_all_regseason_cleaned_1996-2021.csv")
...
# load data
seeddf <- read_csv("~/Google Drive/March_madness/March_madness-master/2021/seeded_all_regseason_cleaned_1996-2021.csv")
...
tourney <- read_csv("~/Google Drive/March_madness/March_madness-master/2021/renamed_all_tournament_wins_1996-2018.csv")
...
write_csv(both_vars_data_all,"~/Google Drive/March_madness/March_madness-master/2021/Processed_data/both_model_data.csv")
