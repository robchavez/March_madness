...
setwd("~/Google Drive/March_madness/March_madness-master/2021")

# Set up loop
all_tournaments_df <- data.frame()

# Run over seasons
for(year in c(1996:2018,2021)){
  ...
  finalfour_scores <- as.numeric(east_bracket[seq(2,12,2)])
...
#write.csv(all_tournaments_df,"~/Google Drive/March_madness/March_madness-master/2021/all_tournament_wins_1996-2018.csv")
