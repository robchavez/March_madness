...
for(year in c(1996:2019)){
  ...
  final_four_bracket <- team[245:256]
...
write.csv(all_tournaments_df,"~/Google Drive/March_madness/March_madness-master/2022/all_tournament_wins_1996-2019.csv")
...
#### Run 2021 separately because covid cancels
...
for(year in c(2021)){
  ...
  # add missing COVID-cancelled games for 2021
  team <- append(team, 1, after = 86)
  team <- append(team, 0, after = 88)
...
write.csv(all_tournaments_df,"~/Google Drive/March_madness/March_madness-master/2022/all_tournament_wins_2021_only.csv")

df1996_2019 <- read_csv("~/Google Drive/March_madness/March_madness-master/2022/all_tournament_wins_1996-2019.csv")
df_2021 <- read_csv("~/Google Drive/March_madness/March_madness-master/2022/all_tournament_wins_2021_only.csv")

df_tourn_all <- rbind(df1996_2019, df_2021)

write_csv(df_tourn_all,"~/Google Drive/March_madness/March_madness-master/2022/all_tournament_wins_1996-2021.csv")
