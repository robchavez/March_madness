...
setwd("~/Google Drive/March_madness/March_madness-master/2023")
...
#write.csv(all_tournaments_df,"~/Google Drive/My Drive/March_madness/March_madness-master/2022/all_tournament_wins_1996-2019.csv")
#write.csv(all_tournaments_df,"~/Google Drive/My Drive/March_madness/March_madness-master/2023/all_tournament_wins_post2021.csv")

df1996_2021 <- read_csv("~/Google Drive/March_madness/March_madness-master/2022/all_tournament_wins_1996-2021.csv")
df1996_2021 <- df1996_2021[,-1]

df_tourn_all <- rbind(df1996_2021, all_tournaments_df)

write_csv(df_tourn_all,"~/Google Drive/March_madness/March_madness-master/2023/all_tournament_wins_1996-2022.csv")
